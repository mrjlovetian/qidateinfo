...
canBeDismissedByUser:(BOOL)dismissingEnabled
{
    ...
    if ((self = [self init]))
    {
        ...
        UIColor *fontColor = [HexColor colorWithHexString:[current valueForKey:@"textColor"]
                                                   alpha:1.0];
        ...
        [self.titleLabel setShadowColor:[HexColor colorWithHexString:[current valueForKey:@"shadowColor"] alpha:1.0]];
        ...
        if ([subtitle length])
        {
            ...
            UIColor *contentTextColor = [HexColor colorWithHexString:[current valueForKey:@"contentTextColor"] alpha:1.0];
            if (!contentTextColor)
            {
        ...
        if ([buttonTitle length])
        {
            ...
            UIColor *buttonTitleShadowColor = [HexColor colorWithHexString:[current valueForKey:@"buttonTitleShadowColor"] alpha:1.0];
            ...
            UIColor *buttonTitleTextColor = [HexColor colorWithHexString:[current valueForKey:@"buttonTitleTextColor"] alpha:1.0];
        ...
        if (![TSMessage iOS7StyleEnabled])
        {
            ...
            self.borderView.backgroundColor = [HexColor colorWithHexString:[current valueForKey:@"borderColor"]
                                                                    alpha:1.0];
