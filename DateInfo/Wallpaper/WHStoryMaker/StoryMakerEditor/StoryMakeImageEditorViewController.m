...
- (void)configureView
{
    ...
    [self.cancelBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.mas_equalTo(self.view.mas_top).offset(SCREENAPPLYHEIGHT(61));
...
- (StoryMakeStickerView *)stickerFooterView
{
    if (!_stickerFooterView) {
        ...
        _stickerFooterView.frame = CGRectMake(0, CGRectGetMaxY(self.view.frame), ScreenWidth, ScreenHeight);
...
- (StoryMakeSelectColorFooterView *)colorFooterView
{
    if (!_colorFooterView) {
        ...
        _colorFooterView.frame = CGRectMake(0, CGRectGetMaxY(self.view.frame), ScreenWidth, ScreenHeight);
